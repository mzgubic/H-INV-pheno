...
def makePlot():
  ...
  mg = r.TMultiGraph()
  leg = r.TLegend(0.2, 0.19, 0.4, 0.39)
  leg.SetFillStyle(0)
  leg.SetBorderSize(0)
  leg.SetTextFont(62)
  ...
  dummyHist.SetTitleOffset(1.3,"X") #0.75
  dummyHist.SetTitleSize(.05,"Y")
  dummyHist.SetLabelSize(.05,"Y")
  ...
  # add text
  if modelname == "D5":
    lat.DrawLatex(0.25,0.92,"#color[216]{D5d}")
    lat.DrawLatex(0.10,0.92,"#color[205]{D5c}")
  if modelname == "D6":
    lat.DrawLatex(0.40,0.92,"#color[216]{D6b}")
    lat.DrawLatex(0.10,0.92,"#color[205]{D6a}")
  if modelname == "D7":
    lat.DrawLatex(0.40,0.92,"#color[216]{D7c}")
    lat.DrawLatex(0.10,0.92,"#color[205]{D7a}")
  ...
  # print canvas
  canv.Update()
  canv.Print(modelname+"_2models.pdf")
  outf.cd()
